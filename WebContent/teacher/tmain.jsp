...
<body>
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north'" class="north" style="height:60px">
        	...
        	<ul>
        		<li class="a">[<span style="color:red">${teacher.tname }</span>]欢迎登陆一心教育系统</li>
        ...
        <div id="personalInfo" title="修改密码">
      		<table cellpadding="5" align="center">
				...
				<tr>
					<td>用户名:</td>
					<td><input value="${teacher.tname }" class="easyui-validatebox textbox validatebox-text" type="text" id="updateUname" style="background: #F5F5F5;" disabled="disabled">
					</td>
				</tr>
				<tr>
					<td>原密码:</td>
        ...
        <div data-options="region:'west'" title="导航菜单" style="width:220px;">
        	<div class="easyui-accordion" style="width:200px;height:300px" data-options="fit:true">
				...
				<div title="个人信息">
					<ul>
						<li><a class="easyui-linkbutton btn" data-options="plain:true" href="attendance.html">考勤</a></li>
				...
				<div title="学习资料">
					<ul>
						...
						<li><a class="easyui-linkbutton btn" data-options="plain:true" href="addData.html">添加资料</a></li>
    ...
    <script type="text/javascript">
    	...
    	function modify(){
			...
			if(newPassword==newPasswordAgain){
				$.post("../teacher.do", {op:'update',tname:updateUname,oldPwd:oldPassword,newPwd:newPassword}, function(data) {
					if(data==0){
