...
<body>
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north'" class="north" style="height:60px">
        	...
        	<ul>
        		<li class="a">[<span style="color:red">${student.sname }</span>]欢迎登陆一心教育系统</li>
        ...
        <div id="personalInfo" title="修改密码">
      		<table cellpadding="5" align="center">
				...
				<tr>
					<td>用户名:</td>
					<td><input value="${student.sname }" class="easyui-validatebox textbox validatebox-text" type="text" id="updateUname" style="background: #F5F5F5;" disabled="disabled">
					</td>
				</tr>
				<tr>
					<td>邮箱:</td>
					<td><input value="${student.qq }" class="easyui-validatebox textbox validatebox-text" type="text" id="qq" style="background: #F5F5F5;" disabled="disabled">
					</td>
				</tr>
				<tr>
					<td>验证码:</td>
					<td><input class="easyui-validatebox textbox validatebox-text" type="text" id="yzm" style="background: #F5F5F5;">
					</td>
        ...
        <div data-options="region:'west'" title="导航菜单" style="width:220px;">
        	<div class="easyui-accordion" style="width:200px;height:300px" data-options="fit:true">
				...
				<div title="个人信息">
					<ul>
						<li><a class="easyui-linkbutton btn" data-options="plain:true" href="perfectMessage.html">完善个人信息</a></li>
						<li><a class="easyui-linkbutton btn" data-options="plain:true" href="addQJ.html">请假申请</a></li>
						<li><a class="easyui-linkbutton btn" data-options="plain:true" href="showQJ.html">请假记录</a></li>
					</ul>
				</div>
				<div title="学习资料">
					<ul>
						<li><a class="easyui-linkbutton btn" data-options="plain:true" href="showData.html">资料信息</a></li>
				...
				<div title="信息反馈">
					<ul>
						<li><a class="easyui-linkbutton btn" data-options="plain:true" href="addFB.html">校长邮箱</a></li>
					</ul>
				</div>
			</div>
    ...
    <script type="text/javascript">
    	...
    	function yzm(){
    		var qq=$('#qq').val();
    		$.post("../student.do", {op:'yzm',qq:qq}, function(data) {
    	...
    	function modify(){
			...
			if(newPassword==newPasswordAgain){
				$.post("../student.do", {op:'modify',sname:updateUname,yzm:yzm,oldPwd:oldPassword,newPwd:newPassword}, function(data) {
					if(data==2){
